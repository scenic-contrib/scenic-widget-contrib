...
#   def start_link(%{
#     name: name,     # registered name of this process
#     state: state,   # the actual fluxus state
#     topic: topic    # the PubSub topic the store holds & broadcasts data for
#   } = args) do
#     Agent.start_link(fn -> args end, name: name)
#   end
...
#     Agent.update(RadixStore, fn store -> %{store|state: new_state} end)
#   end
...
#     Agent.update(RadixStore, fn store ->
#       new_state
#     end)
#   end
