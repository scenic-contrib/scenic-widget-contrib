defmodule WidgetWorkbench.DeskComponent do
  @moduledoc """
  A description of the WidgexComponent and its purpose goes here.
  """
  ...
  # Render function
  @doc """
  Rendering function for the WidgetWorkbench.DeskComponent.
  """
...
#   def render(%Frame{} = f, %State{} = state) do
#     Scenic.Graph.build()
#   end
# end
...
#     new_graph = render(scene.assigns.frame, scene.assigns.state)
...
#         %{assigns: %{state: _current_state}} = scene
#       ) do
...
#     graph
#     |> Scenic.Primitives.text(text, translate: {250, 120}, font_size: 36, fill: :yellow)
