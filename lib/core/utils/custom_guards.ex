defmodule ScenicWidgets.Core.Utils.CustomGuards do
  @moduledoc """
  ...
  defmacro __using__(_opts) do
    ...
    # #NOTE: Sadly, in macros we can't use recursion over a list of args...
      defguard all_positive_integers(a, b)
               when is_positive_integer(a)
               and  is_positive_integer(b)

      defguard all_positive_floats(a, b)
               when is_positive_float(a)
               and  is_positive_float(b)
