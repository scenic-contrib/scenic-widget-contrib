defmodule ScenicWidgets.TextPadTest do
    use ExUnit.Case
 
    @testmodule ScenicWidgets.TextPad
 
    test "construct a basic %TextPad{} struct" do
       t = %ScenicWidgets.TextPad{} = @testmodule.new()
       assert t.lines == [""]
       assert t.mode == :edit
       assert t.scroll == {0, 0}
    end
